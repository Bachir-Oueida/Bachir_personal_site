...
export default function Intro() {
    return (
        <div className="intro-container">
            <h1 className="intro-title">BACHIR OUEIDA</h1>
            <h2 className="intro-subtitle">Top Beverly Hills Luxury Real Estate Agent</h2>
            ...
            <div className="intro-button-container">
                <a href="#" className="intro-button">Learn More</a>
            </div>
        </div>
    )
}